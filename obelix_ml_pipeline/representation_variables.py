...
AVAILABLE_LIGAND_REPRESENTATION_TYPES = ['dft_nbd_model', 'dl_chylon', 'ecfp', 'sigmangroup','dft_nbd_model_fairsubset', 'dl_chylon_fairsubset', 'ecfp_fairsubset', 'sigmangroup_fairsubset']
